...
def inputvector_X(sequence, window=15): #identical to def inputvector_X(sequence, window=3):
    padding = window//2
...
if __name__ == '__main__':
    ...
    result_FASTA = FASTA_to_inputvectorX(parse_fasta('../project/datasets/FASTAfile.fasta'))
    #print (result_FASTA)
